...
# 3. Add axis labels using LaTeX notation for phi1 and phi2
...
# 4. Plot the ideal symbols and their respective labels
for name, (x, y) in S.items():
    # Plot the point
    plt.scatter(x, y, color='black', s=200, zorder=5)
    # Add symbol name (S1-S4) near the point
    plt.text(x*1.15, y*1.15, name, fontsize=16, fontweight='bold', ha='center')

# 5. Final plot styling and formatting
plt.title('Theoretical Constellation & Decision Boundaries', fontsize=14)
